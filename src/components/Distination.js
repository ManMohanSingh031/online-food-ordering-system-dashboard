...
const Distination = () => {
  return (
    <div>
      <div className="flex items-center justify-center h-6 w-6 top-[-40px] right-20 rounded-full bg-red-600 float-right relative">
        <div className="h-3 w-3 rounded-full bg-white flex justify-center absolute">
          <div className="h-16 w-0.5 top-4 bg-red-600 absolute">
            ...
            <span className="absolute text-lg bottom-[-30px] left-[-30px]">
              Distination
            </span>
          </div>
        </div>
